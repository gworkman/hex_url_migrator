defmodule HexUrlMigratorTest do
  ...
  describe "migrate_content/1" do
    test "migrates public hexdocs URLs" do
      ...
      assert {^expected, 1, ["https://my-package.hexdocs.pm"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates public hexdocs URLs without protocol" do
      ...
      assert {^expected, 1, ["another-package.hexdocs.pm"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates multiple public URLs" do
      ...
      assert {^expected, 2, ["pkg-1.hexdocs.pm", "pkg-2.hexdocs.pm"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates organization hexdocs URLs" do
      ...
      assert {^expected, 1, ["https://my_org.hexorg.pm/my_package"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates organization hexdocs URLs with dashes in org" do
      ...
      assert {^expected, 1, ["https://my-org.hexorg.pm/my_package"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "does not migrate hexdocs.pm as an organization (handled as public)" do
      ...
      assert {^expected, 1, ["https://phoenix.hexdocs.pm"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "replaces underscores with dashes only in public URL package names" do
      ...
      assert {^expected, 1, ["my-long-package-name.hexdocs.pm"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "preserves underscores in organization names and package names for org URLs" do
      ...
      assert {^expected, 1, ["my_org.hexorg.pm/my_package"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates public URLs with additional paths, anchors, and parameters" do
      ...
      assert {^expected, 1, ["https://phoenix.hexdocs.pm/Phoenix.HTML.html#content?key=val"]} = HexUrlMigrator.migrate_content(content)
    end
    ...
    test "migrates org URLs with additional paths, anchors, and parameters" do
      ...
      assert {^expected, 1, ["https://my_org.hexorg.pm/my_package/api-reference.html#summary?v=1"]} = HexUrlMigrator.migrate_content(content)
    end
  end
end
